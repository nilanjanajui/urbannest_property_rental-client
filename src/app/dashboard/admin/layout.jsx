...
import { FaUsers, FaBuilding, FaCalendarAlt, FaExchangeAlt, FaUser, FaHome, FaBars, FaSignOutAlt } from "react-icons/fa";
...
const navLinks = [
    ...
    { href: "/dashboard/admin/properties", label: "All Properties", icon: FaBuilding },
    { href: "/dashboard/admin/bookings", label: "All Bookings", icon: FaCalendarAlt },
    { href: "/dashboard/admin/transactions", label: "Transactions", icon: FaExchangeAlt },
    { href: "/dashboard/admin/profile", label: "Profile", icon: FaUser },
];
                ...
                <nav className="flex-1 p-4 space-y-1">
                    ...
                    {navLinks.map(({ href, label, icon: Icon }) => (
                        <Link
                            key={href}
                            href={href}
                            className={`flex items-center gap-3 px-4 py-3 rounded-xl text-sm transition-colors ${isActive(href)
