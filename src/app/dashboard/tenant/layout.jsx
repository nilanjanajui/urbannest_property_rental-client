...
import { FaCalendarAlt, FaHeart, FaUser, FaHome, FaBars, FaSignOutAlt } from "react-icons/fa";
...
const navLinks = [
    ...
    { href: "/dashboard/tenant/favorites", label: "Favorites", icon: FaHeart },
    { href: "/dashboard/tenant/profile", label: "Profile", icon: FaUser },
];
